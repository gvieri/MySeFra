...
//		$menu->drawMenu();
	...
	//	."</table><table class=\"table table-striped table-bordered\">";
		...
		echo "<TH colspan='2'>".LISTE_OPERAZIONI."</TH>";
...
//		$query="select * from ".$this->tablename." order by position";;
		...
		$where="";
//			echo "<hr> special".$this->specialSearch."<hr>";
...
//		echo "<hr>".$query."<HR>";
	...
	//		echo "<input type='checkbox' name='selezionate[]' value='".$row[$this->namecolumnarray[0]]."' id='id_selezionate".$row[$this->namecolumnarray[0]]."' />";
			...
			echo "</td>";
			echo "<td>"
			."<form action='".$_SERVER['PHP_SELF']."' method='post'><input type='hidden' name='azione' value='M'><input type='hidden' name='id' value='".$row[$this->namecolumnarray[0]]."' ><input type='submit' value='M'></form>"
			."</td><td>"
			."<form action='".$_SERVER['PHP_SELF']."' method='post'><input type='hidden' name='azione' value='Delete'><input type='hidden' name='id' value='".$row[$this->namecolumnarray[0]]."' ><input type='submit' value='C'></form>"
			."</td>";
			echo "<td>"
